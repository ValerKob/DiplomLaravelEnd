...
<section class="portfolio_details_area section_gap">
    <div class="container">
        <div class="text-center" style="margin: -50px 0 50px 0;">
            <h2 class="text-left" style="color: #000;">5 Урок <br>Разработка функционала официанта</h2>
        </div>
        <div class="">
            <div class="row">
                <div class="offset-lg-12 col-lg-12">
                    <div class="mt-30">
                        ...
                        <p>
                            Разработать дизайн сотрудников. Сотрудники должены иметь возможность выполнять следующие функции:
            ...
            <div class="row mt-5">
                <div class="offset-lg-1 col-lg-5">
                    <div class="portfolio_right_text mt-30">
                        <p>
                            Для создания страницы Сотрудники, необходимо в папке Pages, создать файл AdminShift.jsx и импортировать в него всё содержимое файла WSR-Master/admin-shift.html, с учётом требований технологий фреймворка React.
                        </p>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row mt-5">
                <div class="offset-lg-1 col-lg-5">
                    <div class="portfolio_right_text mt-30">
                        <p>
                            Итоговый результат действий, это получение списка всех сотрудников, с возможностью добавлять нового сотрудника, как должно выглядеть можно увидеть на рисунке.
                        </p>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row mt-5">
                <div class="col-lg-6">
                    <div class="portfolio_right_text mt-30">
                        <iframe class="video" width="500" height="300" src="https://www.youtube.com/embed/QzAH7MTIZ04" title="React JS фундаментальный курс от А до Я" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="offset-lg-1 col-lg-5">
                    <div class="portfolio_right_text mt-30" style="margin-top: 30px;">
                        ...
                        <p style="text-indent: 20px;">
                            В видео подробно рассказано и показано, как разработать фунционал официанта.
                        </p>
                    </div>
                </div>
            </div>
