...
<section class="portfolio_details_area section_gap" style="padding: 200px 0 100px 0;">
    <div class="container">
        <div class="text-center" style="margin: -50px 0 50px 0;">
            <h2 class="text-left" style="color: #000;">6 Урок <br>Разработка функционала повара</h2>
        </div>
        <div class="">
            <div class="row">
	...
	to { <br>
		opacity: 1; <br>
            ...
            <div class="row mt-5">
                <div class="col-lg-6">
                    <div class="portfolio_right_text mt-30">
                        <iframe class="video" width="500" height="300" src="https://www.youtube.com/embed/AZhWZYlwlI4" title="React JS фундаментальный курс от А до Я" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="offset-lg-1 col-lg-5">
                    <div class="portfolio_right_text mt-30" style="margin-top: 30px;">
                        ...
                        <p style="text-indent: 20px;">
                            В видео подробно рассказано и показано, как разработать фунционал повара.
                        </p>
                    </div>
                </div>
            </div>
